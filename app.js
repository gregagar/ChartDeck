...
function openLibraryDrawer() {
  ...
  els.backToLibraryButton.setAttribute("aria-expanded", "true");
}

function closeLibraryDrawer() {
  document.body.classList.remove("library-drawer-open");
  els.backToLibraryButton.setAttribute("aria-expanded", "false");
}
...
els.chartMorePopover.addEventListener("click", event => {
  ...
  if (action === "autoscroll") { settings.autoScroll = !settings.autoScroll; saveAll(); applySettings(); showToast(settings.autoScroll ? "Auto-scroll on" : "Auto-scroll off"); }
